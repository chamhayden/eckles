...
const CourseOutline25T1 = () => {
  ...
  return (
    <>
      ...
      <Typography variant="body1" gutterBottom>
        On a typical week we will only have the live lecture (2 hours). The live lecture will be replaced by approximately 2 hours of pre-recorded lectures to watch each week. Please note:
      </Typography>
      <Typography variant="body1" gutterBottom>
        <ul>
          <li>It's critical that you watch the 2 hours of pre-recorded lectures each week <em>prior</em> to the live lecture</li>
