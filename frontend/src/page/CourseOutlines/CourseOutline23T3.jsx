...
const CourseOutline23T3 = () => {
  ...
  return (
    <>
      ...
      <Typography variant="body1" component="div" gutterBottom>
        <ul>
          <li>Assignments now explicitly link to the relevant lecture content to make it easier to follow</li>
          <li>Assignment 2 is now providing Static HTML which will allow us to both auto mark it and reduce student load</li>
