	...
	return (
		<>
			...
			<Body>
				...
				It is a very strict style guide so we don't enforce every principle, but
				do take it's guidance generally.
			</Body>
			<Body color="red">
			...
			<ul>
				...
				<li>
					<a href="#jsx-comments">
						4.2. Comments (And examples of E2E/Component testing)
					</a>
				</li>
				<li>
				...
				<li>
					<a href="#jsx-functional-vs-class">
						4.6. Functional VS. Class Components
					</a>
				</li>
				<li>
...
const my-component = () => {
    ...
    //...
			...
			<Body>
				Use comments to explain what your components are for and what they do.
				This is not only for you, but also for your group partner. Additionally,
				they are also very important when{" "}
				<b>
					describing the test cases you have written for component and E2E
					testing
				</b>
				.
			</Body>
...
describe('Button component', () => {
  ...
  // etc. etc...
			...
			<Body>
				Note that you do not need to follow the above verbatim - It is to just
				give a guide of good commenting habits.
			</Body>
			...
			<Body>
				Modularisation is an essential part of building scalable React
				applications (or any project). If you find your components becoming
				extremely bloated with loads of hooks in it with deep nesting (i.e., not
				shallow), chances are that it can be broken into smaller components.{" "}
				<b>Each component should ideally have a single responsibility</b> so it
				is much easier to perform component testing.
			</Body>

			<Body>
				It is also best practice to limit it to <b>one component per file</b>{" "}
				when possible, with the filename being the component's name. This is for
				easier readability and easier time locating where a component is
				written. If you find a file housing many components and those components
				are being used by other components, then that is a sign to split it up.
			</Body>
  ...
  return (
    <Fragment>
      ...
      <TVGuide />
			...
			<Body>
				You'll be given a pre-setup ESLint with your React Assignment.{" "}
				<b>Do not ignore</b> the errors and warnings it outputs, as it will
				point out little practices you haven't followed.
			</Body>
			...
			<Body>
				Note that the ESLint compiler errors shown above was using the
				configuration from 22T3. Please use the configuration given to you in
				your Assignment.
			</Body>
			...
			<Body>
				When you're working on a React project, it's highly recommended avoid
				the `document` keyword, which you may have used in previous assignments.
				This is because React already manages DOM manipulation for you through
				its virtual DOM. Using this keyword also hinders your components
				reusability (as seen below). By relying on the `document` keyword,
				you're overlooking the innovative features that make React so widely
				used.
			</Body>
  ...
  return (
    ...
    >
      {isHovering ? 'Hovering' : 'Not Hovering'}
			...
			<H5 id="jsx-functional-vs-class">
				{emoji} 4.6. Functional VS. Class Components
			</H5>

			<Body>
				Stick to <b>Functional</b> components rather than Class components. This
				is because, but not limited to:
			</Body>
			<ul>
				<li>
					<b>Simplicity</b> - It is easier to test and understand Functional
					components as you won't need to worry about complex concepts such as
					lifecycle methods or `this` keyword.
				</li>
				<li>
					<b>Modernity</b> - With Functional components being the most popular,
					there is more resources online to help you out. There are also a lot
					more libraries available for Functional components compared to Class
					components.
				</li>
				<li>
					<b>Hooks</b> - These simplify state management, handling side effects
					and the lifecycle functionalities in components without the need of
					classes.
				</li>
			</ul>
...
export default ButtonClicker;`,
			...
			<Body>
				When it comes to CSS, <b>do not use universal CSS</b> (i.e., importing a
				`.css` file into a React component). Likewise, you should also avoid
				inline styling. See the following lectures for more information:
			</Body>
			<ul>
				<li>
					<a href="https://youtu.be/Z0OPBwLu5s0">Global CSS</a> for why it is
					not great practice.
				</li>
				<li>
					<a href="https://youtu.be/o81ktwwig3g">CSS Frameworks</a> for what the
			...
			<Body>
				...
				documentation](https://mui.com/material-ui/getting-started/overview/) to
				maximise the utility of these practices. Also, you are not just
				restricted to MUI; feel free to explore other libraries that offer
