...
const DueDateAdjustments = () => {
  return <>
    ...
    <p>Sometimes, the due date will pass before special consideration has made a decision on your situation. In this case it's important that you:</p>
    <ul>
      <li>You still make sure you put yourself in a situation where what is on master at the due date is your best attempt by that point - just in case special consideration rejects your submission.</li>
