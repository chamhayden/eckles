...
const CourseOutline22T1 = () => {
  ...
  return (
    <>
      ...
      <Typography variant="body1" component="div" gutterBottom>
        The final exam will be a 3 hour exam that begins at 2pm (AEST) and ends at 5pm (AEST) on
        10th May 2022.
      </Typography>
      <Typography variant="body1" component="div" gutterBottom>
      ...
      <Typography variant="body1" component="div" gutterBottom>
        The exam will be worth X marks. those X marks will make up the 20% value of the course. X
