  ...
  return (
    <>
      ...
      <Typography variant="body" component="div" gutterBottom>
        Setup locally for COMP6080 is remarkably simple. You simply require the installation of a <b>web browser</b>, along with <b>any text editor</b>, and the <b>NodeJS interpreter</b>. Please complete Steps (1) before term, and Steps (2) before week 3.
      </Typography>
      ...
      <Typography variant="body" component="div" gutterBottom>
        NodeJS can be installed on <b>Windows</b>, <b>MacOS</b>, and <b>Linux</b> by downloading it via the <a target="_blank" href="https://nodejs.org/en/download/">NodeJS website</a>. NPM is automatically installed alongside NodeJS.
      </Typography>
      ...
      <Typography variant="body" component="div" gutterBottom sx={{ mt: 1 }}>
        <ol>
          <li>If you haven't already, install <a target="_blank" href="https://brew.sh">homebrew</a>.</li>
          <li>Open a terminal, and run <pre><code>brew install node</code></pre></li>
        </ol>
      </Typography>
      ...
      <Typography variant="body" component="div" gutterBottom sx={{ mt: 1 }}>
        In the world of Javascript development, an alternative to NPM called <b>yarn</b> is sometimes used.
      </Typography>

      <Typography variant="body" component="div" gutterBottom sx={{ mt: 1 }}>
        To install <b>yarn</b> on Windows (WSL) or Linux, open a terminal and run:
        <pre><code>sudo npm i -g yarn</code></pre>
      </Typography>
      ...
      <Typography variant="body" component="div" gutterBottom sx={{ mt: 1 }}>
        You can run the NodeJS interpreter in repl mode. This is a good way to try out if you install NodeJS correctly. It's very similar to running <b>python3</b> in repl mode.
      </Typography>

      <Typography variant="body" component="div" gutterBottom sx={{ mt: 1 }}>
        Simply open a terminal and enter <code>node</code> into the terminal and press enter. After this, you should be able to enter any nodejs compatible statement and retrieve the output. Examples of things you could enter are:
        <ul>
          <li><code>console.log('hello world')</code> - prints hello world, returns nothing</li>
          <li><code>3 + 4</code> - returns 7</li>
          <li><code>const a = 5</code> - assigns 5 to a variable, returns nothing</li>
        </ul>
