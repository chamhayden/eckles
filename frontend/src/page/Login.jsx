			...
			<Paper className={classes.paper}>
				...
				<form className={classes.form}>
					...
					<p className={classes.disclaimer}>
						Your password and credentials are not stored by either this software
						or by teaching staff. If you change your UNSW password due to
						suspected compromise, please email cs6080@cse.unsw.edu.au to inform
						us as well.
					</p>
					<Button
						fullWidth
