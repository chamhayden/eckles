...
export const getPrimaryNavList = (term) => {
	return [
		...
		},
		{
			...
			Icon: ForumIcon,
			description:
				"Post questions and get answers about course or content queries",
		},
		{
			title: "Timetable",
			route: "/timetable",
			...
			children: [
				{
					...
					Icon: WorkIcon,
					description:
						"View major programing assignments provided in the course",
				},
				{
					title: "Exam",
			...
			children: [
				{
					...
					description:
						"View simple instructions to get setup and ready for term",
				},
				{
					title: "Resources",
					...
					description:
						"See a list of resources that can help you expand your knowledge",
				},
				{
					title: "Style Guide",
					route: `/style`,
					Icon: PaletteIcon,
					description:
						"View our style guide for different languages in the course",
				},
			],
		},
	];
	...
	return [
		{
			...
			loginRequired: true,
			route:
				"https://docs.google.com/forms/d/e/1FAIpQLScTvTvH1Hm64hLefcMoZrhRzuyxcnZUw6ekOjHTF23cD8eweg/viewform",
			external: true,
			Icon: HearingIcon,
			description:
				"Provide feedback to course staff if you have any comments to share",
		},
		{
			title: "Source Code",
			loginRequired: true,
