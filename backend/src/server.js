...
app.get('/api/gradesearch', (req, res) => {
  ...
  const includeAss4 = [
    ...
    'ass4_git_penalty',
    'ass4_days_late',
    'ass4_days_late_penalty',
    'ass4_other_penalty_deduction',
    'ass4_compliance_milestone1',
    'ass4_compliance_milestone2',
    'ass4_compliance_milestone3',
    'ass4_compliance_milestone4',
    ...
    'ass4_usability_comments',
    'ass4_accessibility_comments',
